...
def show_home_page():
    ...
    # Display sample visualizations to make the home page more appealing
    st.markdown("<h3 class='sub-header'>Sample Visualizations</h3>", unsafe_allow_html=True)
    
    col1, col2 = st.columns(2)
    
    with col1:
        st.markdown("<div class='card'>", unsafe_allow_html=True)
        st.image("https://via.placeholder.com/400x300?text=PCA+Visualization", 
                 caption="PCA Component Visualization", use_column_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
        
    with col2:
        st.markdown("<div class='card'>", unsafe_allow_html=True)
        st.image("https://via.placeholder.com/400x300?text=Clustering+Results", 
                 caption="Clustering Results", use_column_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
